...
public class CateringVendor {
    ...
    protected void generateId() {
        if (this.cateringVendorId == null || this.cateringVendorId.isBlank()) {
            this.cateringVendorId = BeanUtil.getBean(IdGeneratorService.class)
                    .generateMonthlyId("CateringVendor",
                            "cateringVendorId",
                            "CVF",
                            null,
                            4);
